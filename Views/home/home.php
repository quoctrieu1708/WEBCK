...
<style>
    .single-product {
        display: flex;
        flex-direction: column; /* Đảm bảo các phần tử bên trong thẻ sản phẩm sắp xếp theo cột */
        height: 100%; /* Đảm bảo chiều cao của mỗi thẻ sản phẩm bằng nhau */
    }

    .product-dsc {
        flex-grow: 1; /* Cho phép phần mô tả sản phẩm tự động lấp đầy không gian còn lại */
        min-height: 150px; /* Điều chỉnh chiều cao cho phần mô tả */
        padding-top: 10px;
        padding-bottom: 10px;
    }
